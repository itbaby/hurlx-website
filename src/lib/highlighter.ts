...
const darkTheme: ThemeInput = {
  ...
  settings: [
    { scope: ["comment.line.number-sign.hurlx", "comment.line.number-sign.bash"], settings: { foreground: "#9ca3af", fontStyle: "italic" } },
    ...
    { scope: ["string.quoted.double.hurlx", "string.quoted.single.hurlx", "string.quoted.double.bash", "string.quoted.single.bash"], settings: { foreground: "#a5f3a4" } },
    { scope: ["variable.parameter.template.hurlx"], settings: { foreground: "#fbbf24", fontStyle: "italic" } },
    { scope: ["string.unquoted.url.hurlx", "string.unquoted.url.bash"], settings: { foreground: "#93c5fd" } },
    ...
    { scope: ["source.bash"], settings: { foreground: "#ffffff" } },
    { scope: ["keyword.control.bash"], settings: { foreground: "#f472b6" } },
    { scope: ["variable.other.bash"], settings: { foreground: "#fbbf24" } },
    { scope: ["constant.numeric.bash"], settings: { foreground: "#fbbf24" } },
  ],
  type: "dark",
};
...
const lightTheme: ThemeInput = {
  ...
  settings: [
    { scope: ["comment.line.number-sign.hurlx", "comment.line.number-sign.bash"], settings: { foreground: "#6b7280", fontStyle: "italic" } },
    { scope: ["keyword.control.hurlx"], settings: { foreground: "#db2777" } },
    { scope: ["keyword.other.hurlx"], settings: { foreground: "#db2777" } },
    { scope: ["constant.numeric.hurlx", "constant.numeric.bash"], settings: { foreground: "#b45309" } },
    ...
    { scope: ["string.quoted.double.hurlx", "string.quoted.single.hurlx", "string.quoted.double.bash", "string.quoted.single.bash"], settings: { foreground: "#15803d" } },
    { scope: ["variable.parameter.template.hurlx"], settings: { foreground: "#b45309", fontStyle: "italic" } },
    { scope: ["string.unquoted.url.hurlx", "string.unquoted.url.bash"], settings: { foreground: "#1d4ed8" } },
    ...
    { scope: ["source.bash"], settings: { foreground: "#000000" } },
    { scope: ["keyword.control.bash"], settings: { foreground: "#db2777" } },
    { scope: ["variable.other.bash"], settings: { foreground: "#b45309" } },
  ],
  type: "light",
};
