...
export async function HighlightedCode({
  ...
  return (
    <div className="[&_pre]:!bg-white [&_pre]:dark:!bg-gray-900 [&_pre]:!p-4 [&_pre]:rounded-xl [&_pre]:text-sm [&_pre]:md:text-base [&_pre]:leading-relaxed [&_pre]:overflow-x-auto [&_pre]:font-mono [&_pre]:!text-gray-900 [&_pre]:dark:!text-gray-100">
